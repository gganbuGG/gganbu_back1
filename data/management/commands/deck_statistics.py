    ...
    def handle(self, *args, **kwargs):
        ...
        for deckdata in deckDatas:
            if d_time > convert_unixtime(str(deckdata.updated_time)[:19]): 
                ...
                """
                units1 = []
                for unit in deckdata.units1:
                    units1.append(korean(unit,"name"))
                units2 = []
                for unit in deckdata.units2:
                    units2.append(korean(unit,"name"))

                decks.append(units1)
                decks.append(units2)
                deckString.append(str(units1))
                deckString.append(str(units2))

        print(Counter(deckString).most_common(3))
