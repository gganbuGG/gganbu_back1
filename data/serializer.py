...
class OneDeckSerializer(serializers.ModelSerializer) :
    ...
    class Meta :
        model = StandardDeck
        fields = ('id', 'name', 'traits', 'core', 'units', 'augments', 'winrate', 'windefencerate', 'avgplace' )
...
class DoubleDeckSerializer(serializers.ModelSerializer) :
    augments = serializers.SerializerMethodField('getAug')
    units = serializers.SerializerMethodField('getKunit')
    core = serializers.SerializerMethodField('getKcore')
    traits = serializers.SerializerMethodField('getTraits')
    otherdeckwin = serializers.SerializerMethodField('getOtherDeckwin')
    otherdeckwindef = serializers.SerializerMethodField('getOtherDeckwindef')
    ...
    def getOtherDeckwindef(self, obj):
        decks = DoubleDeck.objects.filter(parentsdeck=obj.id).order_by("-windefencerate")
    ...
    def getOtherDeckavg(self, obj):
        decks = DoubleDeck.objects.filter(parentsdeck=obj.id).order_by("avgplace")
